function calculate() {
    ...
    document.getElementById("result").innerHTML = p_sum;


    document.getElementById("s_result").innerHTML = s1;
    document.getElementById("i_result").innerHTML = i1;
    document.getElementById("p_result").innerHTML = p1;
    document.getElementById("c_result").innerHTML = c1;
